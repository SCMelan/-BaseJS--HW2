...
// c = 2 + ++a;
// // т.к. префиксный + и обычный + имею одинаковый приоритет и выполняются они справа-налево, то сначала отрабатывает префиксный оператор - ув. переменную а, которую мы ув. ранее (6-я строка), а потом уже складывается с 2

// d = 2 + b++
// // аналогичная ситуация со 2-м примером, постфиксный оператор отрабатывает уже после сложения, по этому результат мы видим с его прошлым значением
// //2 Задание
